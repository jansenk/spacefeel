...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/firstcharacter1.png", __ASSET__assets_images_firstcharacter1_png);
		type.set ("assets/images/firstcharacter1.png", AssetType.IMAGE);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/jansentiletest.png", __ASSET__assets_images_jansentiletest_png);
		type.set ("assets/images/jansentiletest.png", AssetType.IMAGE);
		...
		className.set ("assets/images/tinycharacter.png", __ASSET__assets_images_tinycharacter_png);
		...
		id = "assets/images/firstcharacter1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/jansentiletest.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:keep class __ASSET__assets_images_firstcharacter1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_images_go_here_txt extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_images_jansentiletest_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_tileset_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_tinycharacter_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/firstcharacter1.png") class __ASSET__assets_images_firstcharacter1_png extends flash.display.BitmapData {}
@:file("assets/images/images-go-here.txt") class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray {}
@:bitmap("assets/images/jansentiletest.png") class __ASSET__assets_images_jansentiletest_png extends flash.display.BitmapData {}
@:bitmap("assets/images/tileset.png") class __ASSET__assets_images_tileset_png extends flash.display.BitmapData {}
@:bitmap("assets/images/tinycharacter.png") class __ASSET__assets_images_tinycharacter_png extends flash.display.BitmapData {}
